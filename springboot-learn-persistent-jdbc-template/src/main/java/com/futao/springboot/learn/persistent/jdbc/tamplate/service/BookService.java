package com.futao.springboot.learn.persistent.jdbc.tamplate.service;

import com.futao.springboot.learn.persistent.jdbc.tamplate.dao.BookDao;
...
public class BookService {
    ...
    public String delete(int id) {
        return bookDao.delete(id) > 0 ? "删除成功" : "删除失败";
    }
